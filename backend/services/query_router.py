...
class QueryRouter:
    ...
    CHAT_PATTERNS: list[Pattern] = [
        re.compile(r"^(你好|hi|hello|早上好|晚上好|下午好)\b", re.IGNORECASE),
        re.compile(r"^(谢谢|感谢|多谢|thanks|thank you)\b", re.IGNORECASE),
        re.compile(r"^(再见|拜拜|bye|goodbye)\b", re.IGNORECASE),
